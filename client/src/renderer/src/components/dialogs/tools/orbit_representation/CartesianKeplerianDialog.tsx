...
const defaultOut: IOrbitalElements =
{
    sam: 0,
    sma: 0,
    ecc: 0,
...
export default function CartesianKeplerianDialog(props: Readonly<Props>): react.JSX.Element
{
    ...
    const handleSubmit = async (e: React.FormEvent): Promise<void> =>
    {
        ...
        try
        {
            let response: any = await http.api.put(`/tools/convert-cartesian-to-keplerian`, formIn)

            const result: IOrbitalElements = response.data
