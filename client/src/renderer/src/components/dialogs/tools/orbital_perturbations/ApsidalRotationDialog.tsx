...
/** @function ApsidalRotationDialog */
export default function ApsidalRotationDialog(props: Readonly<Props>): react.JSX.Element
{
    // --- USE STATE ---
    ...
    const handleSubmit = async (e: React.FormEvent): Promise<void> =>
    {
        ...
        try
        {
            let response: any = await http.api.put(`/orbital-perturbations/apsidal-rotation-rate`, formIn)
    ...
    return (
        <DialogRUI
            ...
            popup={{
                title: "Apsidal Rotation",
                content: `Compute the apsidal rotation rates (deg/day) due to J2, lunar and solar gravity.`
                }}
        >
            ...
            <Form.Root className="grid grid-cols-3 gap-4 mb-4">
                ...
                <OutputField
                    label="J2 Apsidal Rotation Rate"
                ...
                <OutputField
                    label="Lunar Apsidal Rotation Rate"
                ...
                <OutputField
                    label="Solar Apsidal Rotation Rate"
